...
@include('partials.slide-profil')

<div class="container">
  {{-- Breadcrumb --}}
  <div class="badge rounded-4 bg-blue mt-3">
    <div class="px-2 py-1">
  ...
  <div class="my-5">
    <div class="text-center">
      <img src="{{ asset('assets/img/pasar-pagi-lawas.jpg') }}" alt="" class="w-75">
    </div>
    <div class="card mx-auto mt-5 rounded-5 bg-blue-18 border-0">
      <div class="card-body">
