    ...
    <div class="my-3" style="margin-right: 100px; margin-left: 100px">
        <div class="d-flex justify-content-between container-fluid text-blue">
            ...
            <div class="d-flex justify-content-start">
                ...
                <a class="pe-2" href="#">
                    <img src="{{ asset('assets/logo/dpupr-kota-samarinda.png') }}" alt="dpupr-kota-samarinda"
                        style="height: 54px">
                </a>
                <p class="fw-bold m-0">
            ...
            <ul class="navbar-nav mx-auto my-2 my-lg-0" style="--bs-scroll-height: 100px;">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="{{ url('profil/sejarah-kota-samarinda') }}">Sejarah Kota
                                Samarinda</a></li>
                        <li><a class="dropdown-item" href="{{ url('profil/sejarah-dpupr-kota-samarinda') }}">Sejarah
                                DPUPR Kota Samarinda</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">Informasi yang Wajib Disediakan dan Diumumkan Secara
                                Berkala</a></li>
